...
import com.flingsoftware.personalbudget.app.application.PBApplication;
...
public class DatabaseOpenHelperWrapper {
    private static final int VERSIONE_APP = 14;
    public static final String NOME_DATABASE = "BudgetPersonale";
    private static final DatabaseOpenHelper databaseOpenHelper = new DatabaseOpenHelper();
    ...
    private static class DatabaseOpenHelper extends SQLiteOpenHelper {
        private DatabaseOpenHelper() {
            super(PBApplication.getAppContext(), NOME_DATABASE, null, VERSIONE_APP);
        }
        ...
        private void aggiornaVersione5(SQLiteDatabase db) {
            ...
            nuovaVoce.clear();
            nuovaVoce.put("voce", PBApplication.getAppContext().getString(R.string.voce_giroconto));
        ...
        private void cancellaBackupAutomatici() {
            String fileList[] = PBApplication.getAppContext().fileList();
            File dir = PBApplication.getAppContext().getFilesDir();
