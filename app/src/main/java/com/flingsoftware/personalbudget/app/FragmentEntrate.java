...
public class FragmentEntrate extends Fragment implements SharedPreferences.OnSharedPreferenceChangeListener {
	...
	//comunicazione all'activity per eliminazione entrate: l'Activity poi richiede l'aggiornamento degli altri Fragment
	public interface EarningsDeletedListener {
		void onDeletedEarning();
	}
	
	public void setEarningsDeletedListener(EarningsDeletedListener listener) {
		earningsDeletedListener = listener;
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		new PlaceHolderWorkerTask().execute(R.drawable.tag_1);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_entrate, container, false);
		
		ivWallet = (ImageView) rootView.findViewById(R.id.fragment_entrate_ivWallet);
		tvToccaPiu = (TextView) rootView.findViewById(R.id.fragment_entrate_tvToccaPiu);
		...
		mAdapter.setViewBinder(new SimpleCursorTreeAdapter.ViewBinder() {
			...
			public boolean setViewValue (View view, final Cursor cursor, int columnIndex) {
				...
				case R.id.tvVoceGruppo:
					...
					SimpleDateFormat mioSdf = new SimpleDateFormat("dd");
				...
				case R.id.tvVoceChild:
					...
					if(icona == null) {
						...
						iconeVeloci.loadBitmap(icona, ivIcona, mPlaceHolderBitmapEntrate, 40, 40);
					}
		...
		mAdapterVoci = new MyExpandableListAdapter(null, getActivity(), R.layout.fragment_spese_entrate_group_item, R.layout.fragment_spese_entrate_child_item, new String[] {"voce", "totale_entrata"}, new int[] {R.id.tvVoceGruppo, R.id.fragment_spese_tvImportoGruppo}, new String[] {"data", "ripetizione_id", "importo_valprin", "voce"}, new int[] {R.id.tvVoceChild, R.id.fragment_spese_entrate_child_item_tvRipetizione, R.id.tvImportoChild, R.id.fragment_spese_entrate_child_item_tvVoce});
		...
		elv.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {		
				if(mActionMode == null) {
					...
					Cursor cDettaglioVoce = dbcEntrateIncassate.getEntrataIncassataX(id);
		            ...
		            case R.id.menu_cancella:
		    			...
		    			builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {	
		    				...
		    				public void onClick(DialogInterface dialog, int which) {
				                ...
				                new EliminaEntrateSelezionateTask().execute(arrSelezionati);
	...
	/*
	 * Aggiorna la TextView del periodo.
	 */
	...
	//aggiungere una entrata
	public void aggiungi() {
		Intent aggiungiEntrata = new Intent(getActivity(), EntrateAggiungi.class);
		getActivity().startActivityForResult(aggiungiEntrata, ACTIVITY_ENTRATE_AGGIUNGI);
	}
	...
	private class RefreshGroupsCursorTask extends AsyncTask<Object, Void, Cursor> {
		...
		protected Cursor doInBackground(Object... params) {
			dbcEntrateIncassate.openLettura();
			if(tipoVisualizzazione == VISUALIZZA_PER_DATA) { 
				mGroupsCursor = dbcEntrateIncassate.getEntrateIncassateIntervalloTotaliPerDataFiltrato(MainPersonalBudget.conto, dataInizio.getTimeInMillis(), dataFine.getTimeInMillis(), ricerca.toString());
			}
			else {
				mGroupsCursor = dbcEntrateIncassate.getEntrateIncassateIntervalloTotaliPerVoceFiltrato(MainPersonalBudget.conto, dataInizio.getTimeInMillis(), dataFine.getTimeInMillis(), ricerca.toString());
			}
	...
	private class RefreshChildrenCursorTask extends AsyncTask<Long, Void, Cursor> {
		...
		protected Cursor doInBackground(Long... params) {
			...
			dbcEntrateIncassate.openLettura();
			if(tipoVisualizzazione == VISUALIZZA_PER_DATA) {
				childCursor = dbcEntrateIncassate.getEntrateIncassateDataXElencoFiltrato(MainPersonalBudget.conto, data, ricerca.toString());
			}
			else {
				childCursor = dbcEntrateIncassate.getEntrateIncassateIntervalloEntrataXFiltrato(MainPersonalBudget.conto, dataInizio.getTimeInMillis(), dataFine.getTimeInMillis(), mVoce, ricerca.toString());
			}
	...
	//AsyncTask per eliminare le entrate selezionate della ListView
	private class EliminaEntrateSelezionateTask extends AsyncTask<Long, Object, Integer> {
		@Override
		...
		protected void onPostExecute(Integer result) {
			...
			if(result>0) {
				earningsDeletedListener.onDeletedEarning();
			}
	...
	private class PlaceHolderWorkerTask extends AsyncTask<Integer, Void, Object> {   
	    ...
	    protected Object doInBackground(Integer... params) {
	    	mPlaceHolderBitmapEntrate = ListViewIconeVeloce.decodeSampledBitmapFromResource(getResources(), params[0], 40, 40);
	    	return null;
	    }
	}
	...
	private class CaricaHashMapIconeTask extends AsyncTask<Object, Void, Object> {   
	    ...
	    protected Object doInBackground(Object... params) {
	    	...
	    	DBCEntrateVoci dbcEntrateVoci = new DBCEntrateVoci(getActivity());
	...
	private EarningsDeletedListener earningsDeletedListener;
